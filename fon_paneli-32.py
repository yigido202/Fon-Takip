    ...
    try:
        ...
        with g2:
            ...
            if dagilim:
                ...
                st.caption("Kaynak: fonun son KAP portfoy raporu; toplam "
                           "%100'den sapabilir (alacak/borc kalemleri).")
            else:
                st.caption("Varlik dagilimi bu fonun raporundan cikarilamadi; "
                           "bir sonraki rapor cekiminde tekrar denenir.")
