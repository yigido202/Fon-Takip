...
st.sidebar.caption("Adetleri yazip Kaydet'e bas — form icinde yazarken sayfa "
                   "yenilenmez. Kaydedilen adetler adrese islenir; sayfayi "
                   "yer imine eklersen sonraki aciliste otomatik gelir.")
