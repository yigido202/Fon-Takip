...
with st.sidebar.expander("❓ Adet kismi nasil kullanilir?"):
    st.markdown(
        ...
        "uygulamasinda 'adet'/'pay sayisi'). Kusuratli olabilir. Elinde "
        "olmayani 0 birak.\n\n"
        "**3.** **💾 Kaydet**'e bas — tabloda Adet ve Benim Tutarim dolar, "
        "ustte toplam cikar.\n\n"
        "**4.** Anahtari geri kapat.\n\n"
        "**Kalicilik:** adetler adrese islenir; sayfayi yer imine ekle.\n\n"
        "**🗑 Sifirla:** tum adetleri temizler.\n\n"
        "**Garantili yontem:** adresin sonuna `?TLY=150&THF=200` yaz.")
...
PORTFOY_TOPLAM, FON_VERI, FON_ANALIZ = [], {}, {}
...
st.caption(f"Son kontrol: {datetime.now():%d.%m.%Y %H:%M} | ~ = tahmin (sepet "
...
with sekmeler[0]:
    ...
    yuzde_kolonlari = ["Gunluk %", "Haftalik %"] + list(GUN_ADLARI.values())
